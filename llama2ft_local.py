...
def generate_llama_response(user_prompt, task_prompt):
    ...
    prompt = f"[INST] You are a helpful medical assistant. Users ask you questions about their health care information. You will help and be as concise and clear as possible.\n\n{task_prompt}\n\n{user_prompt}\n[/INST]"
